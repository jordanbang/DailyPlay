 ...
 ******************************************************************************/
package com.jb.dailyplay.GooglePlayMusicApi.comm;
...
public class ApacheConnector implements IGoogleHttpClient {
    ...
    private HttpResponse execute(final URI uri, final HttpRequestBase request) throws IOException, URISyntaxException {
